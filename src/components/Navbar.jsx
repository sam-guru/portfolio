  ...
  return (
    <div className={`fixed top-0 left-0 w-full z-[999] ${darkMode ? 'bg-black' : 'bg-blue-500'} text-slate-50 h-[100px] flex items-center justify-between px-4`}>      
      ...
      <ul className='hidden md:flex'>
        ...
        <li className='p-5 hover:bg-blue-800 rounded-xl'><a href='#caseStudies'>Case Studies</a></li>
      ...
      <div className={nav ? 'z-10 fixed h-full left-0 top-0 w-[60%] bg-blue-800 dark:bg-black ease-in-out duration-500' : 'fixed left-[-100%]'}>
        ...
        <ul className='p-8 text-2xl'>
          ...
          <li className='p-2'><a href='#caseStudies' onClick={handleNav}>Case Studies</a></li>
