...
const Skills = () => {
  ...
  return (
    <div data-aos="zoom-in" data-aos-delay="200"  className='mt-20 dark:border dark:border-gray-600 bg-black text-gray-400 min-h-[150px] max-w-[1200px] mx-auto grid grid-rows-3 grid-flow-col
        ...
        <h2 className='row-span-3 text-blue-500 text-2xl md:tet-4xl font-bold m-4 mr-0'>
            My <br /> Tech <br /> Stack
        </h2>
        ...
        <div className='flex flex-col items-center m-4 pr-4 md:pr-0 sm:my-0 w-[40px] md:w-[100px]'>
         ...
         <div className='flex flex-col items-center m-4 pr-4 md:mr-0 sm:my-0 w-[40px] md:w-[100px]'>
